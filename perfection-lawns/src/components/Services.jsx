...
const services = [
    ...
    },
    {
        id: 5,
        title: "Mulching",
        description: "Putting fresh mulch in your gardens beds to keep them healthy and beautiful"
    },
    {
        id: 6,
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                {services.map((service) => (
                    <div 
                        ...
                        <a href="#" className='mt-4 inline-block text-green-400 hover:text-blue-500'>Learn More</a>
